...
public class Jeep extends PassengerCar {
    ...
    public Jeep(CarType id, String brand, String carName, String yearOfIssue, double fuelConsumption, double price, String fuel, double acceleration, int maxPassengers, int doors, boolean allRoad) throws CarExceptions {
